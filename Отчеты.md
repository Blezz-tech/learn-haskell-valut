...
1. Поиск англо - русского словаря для OmegaT 
2. Дочитать статью [OmegaT: переводим с помощью компьютера / Хабр](https://habr.com/ru/articles/404061/). 
3. Перевод учебника
4. Изучение учебника (перенести на следующий рабочий день) Learn You a Haskell for Great Good!
	- Introduction
	- Starting Out
